	...
	<div class="container col-md-12">
		...
		<center style="background-color:#F7F7F7;padding:25px">
			<table border=1 class="table table-striped ">
				...
				<?php 
					$sqll=mysqli_query($conn,"Select * from ch_ques_1");
				...
				?>
					...
					<tr>
						...
						<td><a href="../test_edit/test_1_edit.php?id=<?php echo $ID; ?>">Edit</a></td>
						<td><a href="../test_delete/test_1_delete.php?id=<?php echo $ID; ?>">Delete</a></td>
					</tr>
				<?php
					}
				?>
