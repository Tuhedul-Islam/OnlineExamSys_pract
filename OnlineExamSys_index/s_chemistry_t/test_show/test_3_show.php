	...
	<div class="container col-md-12">
		...
		<center style="background-color:#F7F7F7;padding:25px">
			<table border=1 class="table table-striped ">
				...
				<?php 
					$sqll=mysqli_query($conn,"Select * from ch_ques_3");
				...
				?>
					...
					<tr>
						...
						<td><a href="../test_edit/test_3_edit.php?id=<?php echo $ID; ?>">Edit</a></td>
						<td><a href="../test_delete/test_3_delete.php?id=<?php echo $ID; ?>">Delete</a></td>
					</tr>
				<?php
					}
				?>
			...
			<a href="../../select_sub_3.php"><button type="button" class="btn btn-primary"><b>Back</b></button></a>
		</center>
