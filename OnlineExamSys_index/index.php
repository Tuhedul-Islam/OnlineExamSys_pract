	...
	<div class="container">
		<div class="col-md-12 col-sm-12 content_part text-center" >
			...
			<div class="container text-center ">
				...
				<div class="separate">
				<center>
					<a href="select_sub_<?php echo $i;?>.php">
						<div class="pedit">
					    	<p>
					    		<?php 
					    			switch ($i) {
					    				case '1': echo "<b>MATHEMATICS</b>";
					    					break;
					    				case '2': echo "<b>PHYSICS</b>";
					    					break;
				    					case '3': echo "<b>CHEMISTRY</b>";
				    						break;
				    					case '4': echo "<b>ICT</b>";
					    					break;
					    			}
		...
		<!-- <a href="#"><button type="button" class="btn btn-primary"><b>CLICK FOR ALL QUIZ</b></button></a> -->
